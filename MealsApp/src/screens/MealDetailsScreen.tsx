...
const MealDetailsScreen: React.FC<{ route: MealDetailsScreenRouteProp }> = ({ route }) => {
    ...
    return (
        <ScrollView style={styles.rootContainer}>
            ...
            <MealDetails textStyle={styles.detailText} affordability={meal.affordability} complexity={meal.complexity} duration={meal.duration} />
